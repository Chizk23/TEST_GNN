...
export default function TrainingControls() {
  ...
  const handleStart = useCallback(() => {
    // Clear old snapshots before starting new training
    loadSnapshots([])
  ...
  }, [mockMode, hyperparams, selectedTask, setTraining, setGraphData, setGroundTruth, setTrainMask, setTaskData, loadSnapshots])
